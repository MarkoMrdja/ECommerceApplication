...
namespace ECommerceApplication.Server.Migrations
{
    ...
    [Migration("20230228101529_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.Product", b =>
                {
                    b.HasOne("ECommerceApplication.Shared.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceApplication.Shared.ProductVariant", b =>
                {
                    b.HasOne("ECommerceApplication.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerceApplication.Shared.ProductType", "ProductType")
                        .WithMany()
